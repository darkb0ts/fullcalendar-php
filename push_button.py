...
class GpioButton:
    ...
    def update_audio(self):
        ...
        if data:
            ...
            self.middle_audio = "/var/www/html/calendify/" + data[0]['middle_audio']
            ...
            self.middle_audio = "/var/www/html/calendify/upload/audioBell/664b204854b73.mp3"
            self.button_status = 0
            self.timeInterval = 5
            self.Test = 0
        ...
        try:
            ...
            while True:
                ...
                if GPIO.input(self.button_pin) == False:
                    ...
                    self.count = (int(self.timeInterval)*2)-1
